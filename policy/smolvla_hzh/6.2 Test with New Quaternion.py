...
z_values = torch.linspace(0.25, 0.0, 25).tolist() + torch.linspace(0.25, 1.2, 25).tolist()

###### REMEMBER TO UPDATE THE QUATERNION ####
#############################################
# Update the quaternion from the debug output
quaternion = torch.tensor([7.07106781e-01, 7.07106781e-01, -2.00747075e-09, -2.00747075e-09], device='cuda:0')
#############################################
